...
def predict():
    ...
    return render_template('result.html',
                            pred_tox = 'Probability of being a Toxic comment: {}'.format(out_tox),
                            pred_sev = 'Probability of being a Severely toxic comment: {}'.format(out_sev), 
                            pred_obs = 'Probability of being an Obscene comment: {}'.format(out_obs),
                            pred_ins = 'Probability of being an Insult: {}'.format(out_ins),
                            pred_thr = 'Probability of being a Threat: {}'.format(out_thr),
                            pred_ide = 'Probability of being an Identity Hate comment: {}'.format(out_ide)                        
                            )
